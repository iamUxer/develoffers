...
export const DeleteIcon = (props: IconType) => {
  const { size, color, disabled, ...rest } = props;
  return (
    <IconCss size={size} color={color} disabled={disabled} {...rest}>
      <svg
...
export const CloseIcon = (props: IconType) => {
  const { size, color, disabled, ...rest } = props;
  return (
    <IconCss size={size} color={color} disabled={disabled} {...rest}>
      <svg
...
export const UturnLeftIcon = (props: IconType) => {
  const { size, color, disabled, ...rest } = props;
  return (
    <IconCss size={size} color={color} disabled={disabled} {...rest}>
      <svg
...
export const EditIcon = (props: IconType) => {
  const { size, color, disabled, ...rest } = props;
  return (
    <IconCss size={size} color={color} disabled={disabled} {...rest}>
      <svg
...
export const WithDrawIcon = (props: IconType) => {
  const { size, color, disabled, ...rest } = props;
  return (
    <IconCss size={size} color={color} disabled={disabled} {...rest}>
      <svg
